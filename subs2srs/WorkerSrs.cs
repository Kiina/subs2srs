...
namespace subs2srs
{
    ...
    class WorkerSrs
    {
        ...
        /// </summary>
        private string formatAll(List<List<InfoCombined>> combinedAll, int episodeIndex, int lineIndex,
        ...
        private string formatTag(InfoCombined comb, int episodeIndex)
        {
            ...
            string nameStr = name.createName(ConstantSettings.SrsTagFormat,
        ...
        private string formatSequenceMarker(InfoCombined comb, int episodeIndex)
        {
            ...
            string nameStr = name.createName(ConstantSettings.SrsSequenceMarkerFormat,
                episodeIndex + Settings.Instance.EpisodeStartNumber,
                progessCount, startTime, endTime, comb.Subs1.Text, comb.Subs2.Text);
        ...
        private string formatAudioClip(InfoCombined comb, int episodeIndex)
        {
            ...
            string prefixStr = name.createName(ConstantSettings.SrsAudioFilenamePrefix,
                episodeIndex + Settings.Instance.EpisodeStartNumber,
                progessCount, startTime, endTime, comb.Subs1.Text, comb.Subs2.Text);
            ...
            string suffixStr = name.createName(ConstantSettings.SrsAudioFilenameSuffix,
                episodeIndex + Settings.Instance.EpisodeStartNumber,
                progessCount, startTime, endTime, comb.Subs1.Text, comb.Subs2.Text);
        ...
        private string formatVideoClip(InfoCombined comb, int episodeIndex)
        {
            ...
            string prefixStr = name.createName(ConstantSettings.SrsVideoFilenamePrefix,
                episodeIndex + Settings.Instance.EpisodeStartNumber,
                progessCount, startTime, endTime, comb.Subs1.Text, comb.Subs2.Text);
            ...
            string suffixStr = name.createName(ConstantSettings.SrsVideoFilenameSuffix,
                episodeIndex + Settings.Instance.EpisodeStartNumber,
                progessCount, startTime, endTime, comb.Subs1.Text, comb.Subs2.Text);

            outText = $"{prefixStr}{nameStr}{videoExtension}{suffixStr}"; // {3}
        ...
        private string formatSubs1(InfoCombined comb, int episodeIndex)
        {
            ...
            string nameStr = name.createName(ConstantSettings.SrsSubs1Format,
                episodeIndex + Settings.Instance.EpisodeStartNumber,
                progessCount, startTime, endTime, comb.Subs1.Text, comb.Subs2.Text);
        ...
        private string formatSubs2(InfoCombined comb, int episodeIndex)
        {
            ...
            string nameStr = name.createName(ConstantSettings.SrsSubs2Format,
                episodeIndex + Settings.Instance.EpisodeStartNumber,
                progessCount, startTime, endTime, comb.Subs1.Text, comb.Subs2.Text);
