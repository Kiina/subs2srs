...
namespace subs2srs
{
    ...
    public class UtilsCommon
    {
        ...
        public static string[] getNonHiddenFilesInDir(string dir, string searchPatttern)
        {
            if (Directory.Exists(dir))
            {
                List<string> subsFiles =
                    Directory.GetFiles(dir, searchPatttern, SearchOption.TopDirectoryOnly).ToList();
                subsFiles.Sort();
            ...
            if (filePattern.Length > 0)
            {
                ...
                if (Directory.Exists(dir))
                {
                    List<string> allFiles =
                        Directory.GetFiles(Path.GetFullPath(dir), Path.GetFileName(pattern)).ToList();
                    allFiles.Sort();
        ...
        /// </summary>
        private static string callExeAndGetStdout(string exe, string args, bool useShellExecute, bool createNoWindow)
        {
            Process process = new Process();
        ...
        /// </summary>
        public static void startFFmpeg(string ffmpegAudioProgArgs, bool useShellExecute, bool createNoWindow)
        {
        ...
        /// </summary>
        public static void startFFmpegProgress(string ffmpegAudioProgArgs, DialogProgress dialogProgress)
        {
            ...
            try
            {
                ...
                ffmpegProcess.ErrorDataReceived +=
                    new DataReceivedEventHandler(DialogProgress.getFFmpegOutputHandler(dialogProgress));
                ffmpegProcess.Start();
        ...
        /// </summary>
        public static string getFFmpegText(string ffmpegAudioProgArgs)
        {
            Process ffmpegProcess = new Process();
            bool tryAgain = true;
            bool useShellExecute = false;
