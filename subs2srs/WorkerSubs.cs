...
namespace subs2srs
{
    ...
    class WorkerSubs
    {
        ...
        private List<InfoCombined> pass1CombineSubs(List<InfoLine> subs1LineList, List<InfoLine> subs2LineList)
        {
            ...
            {
                InfoCombined combInfo = getCombinedOverlap(info, subs2LineList);
        ...
        {
            combList = combineConsecutiveRepeats(combList);
            combList = combineSkipped(subs2LineList, combList);
        ...
        {
            List<InfoCombined> repeatList = findConsecutiveRepeats(combList);
