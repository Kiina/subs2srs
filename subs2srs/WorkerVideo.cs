    ...
    public class WorkerVideo
    {
        ...
        public bool genVideoClip(WorkerVars workerVars, DialogProgress dialogProgress)
        {
            ...
            foreach (List<InfoCombined> combArray in workerVars.CombinedAll)
            {
                ...
                {
                    entireClipStartTime =
                        UtilsSubs.applyTimePad(entireClipStartTime, -Settings.Instance.VideoClips.PadStart);
                ...
                foreach (InfoCombined comb in combArray)
                {
                    ...
                    progressText = $"Generating video clip: {progessCount.ToString()} of {totalLines.ToString()}";
                    ...
                    DateTime startTime = UtilsSubs.shiftTiming(comb.Subs1.StartTime,
                        -(int) entireClipStartTime.TimeOfDay.TotalMilliseconds);
                    DateTime endTime = UtilsSubs.shiftTiming(comb.Subs1.EndTime,
                        -(int) entireClipStartTime.TimeOfDay.TotalMilliseconds);
                    ...
                    if (Settings.Instance.VideoClips.PadEnabled)
                    {
                        ...
                        filenameStartTime = UtilsSubs.applyTimePad(comb.Subs1.StartTime,
                            -Settings.Instance.VideoClips.PadStart);
                        filenameEndTime =
                            UtilsSubs.applyTimePad(comb.Subs1.EndTime, Settings.Instance.VideoClips.PadEnd);
                    }
                    ...
                    string outFile =
                        $"{workerVars.MediaDir}{Path.DirectorySeparatorChar}{nameStr}{videoExtension}"; // {3}
