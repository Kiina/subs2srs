...
namespace subs2srs
{
    ...
    public class Logger
    {
        ...
        private Logger()
        {
            ...
            logFile =
                $"{ConstantSettings.LogDir}log-{now.Year:0000}{now.Month:00}{now.Day:00}-{now.Hour:00}{now.Minute:00}{now.Second:00}.txt";
        ...
        private string createTimestamp()
        {
            ...
            string time = $"{now.Hour:00}:{now.Minute:00}:{now.Second:00}.{now.Millisecond:000}: ";
        ...
        public void writeSettingsToLog()
        {
            ...
            var(new {ConstantSettings.DefaultIphoneSupport});
