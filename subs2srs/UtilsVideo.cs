...
namespace subs2srs
{
    ...
    public class UtilsVideo
    {
        ...
        public static string formatProfileFileArg(Profilex264 preset)
        {
            ...
            switch (preset)
            {
                case Profilex264.IPod320:
                    profileFile = "libx264-ipod320.ffpreset";
                    break;
                case Profilex264.IPod640:
                    profileFile = "libx264-ipod640.ffpreset";
                    break;
                case Profilex264.Baseline:
                    profileFile = "libx264-baseline.ffpreset";
                    break;
                case Profilex264.Main:
                    profileFile = "libx264-main.ffpreset";
                    break;
                case Profilex264.High:
                    profileFile = "";
                    break;
                case Profilex264.None:
                    profileFile = "";
                    break;
                default:
                    profileFile = "";
            ...
            if (profileFile.Length > 0)
            {
                ...
                profileArg = $"{presetCommand} \"{profilePath}\"";
            }
        ...
        public static string formatPresetFileArg(Presetx264 preset)
        {
            ...
            switch (preset)
            {
                case Presetx264.UltraFast:
                    presetText = "ultrafast";
                    break;
                case Presetx264.SuperFast:
                    presetText = "superfast";
                    break;
                case Presetx264.VeryFast:
                    presetText = "veryfast";
                    break;
                case Presetx264.Faster:
                    presetText = "faster";
                    break;
                case Presetx264.Fast:
                    presetText = "fast";
                    break;
                case Presetx264.Medium:
                    presetText = "medium";
                    break;
                case Presetx264.Slow:
                    presetText = "slow";
                    break;
                case Presetx264.Slower:
                    presetText = "slower";
                    break;
                case Presetx264.VerySlow:
                    presetText = "veryslow";
                    break;
                case Presetx264.Placebo:
                    presetText = "placebo";
                    break;
                case Presetx264.None:
                    presetText = "";
                    break;
                default:
                    presetText = "";
        ...
        public static string formatKeyframeOptionsArg(VideoCodec videoCodec)
        {
            ...
            {
                case VideoCodec.h264:
                    keyframeOptionsArg = "-g 6 -keyint_min 6";
                    break;
                default:
                    keyframeOptionsArg = "";
                    break;
        ...
        {
            string bitrateArg = $"-b:a {bitrate}k";
        ...
        public static string formatStartTimeArg(DateTime startTime)
        {
            ...
            string startTimeArg =
                $"-ss {(int) startTime.TimeOfDay.TotalHours:00.}:{(int) startTime.TimeOfDay.Minutes:00.}:{(int) startTime.TimeOfDay.Seconds:00.}.{(int) startTime.TimeOfDay.Milliseconds:000.}"; // {3}
        ...
        public static ImageSize getResolutionToUseWithCrop(string file, ImageSize desiredSize, ImageCrop crop)
        {
            ...
            {
                ImageSize origSize = getVideoResolution(file);
                ...
                outSize.Width = desiredSize.Width +
                                (totalCropWidth -
                                 (int) (desiredSize.Width / (float) origSize.Width * totalCropWidth));
                outSize.Height = desiredSize.Height +
                                 (totalCropHeight -
                                  (int) (desiredSize.Height / (float) origSize.Height * totalCropHeight));
            }
        ...
        public static DateTime getVideoLength(string file)
        {
            ...
            */
            ...
            {
                videoLength =
                    videoLength.AddHours(Int32.Parse(lineMatchVideoLength.Groups["VideoHr"].ToString().Trim()));
                videoLength =
                    videoLength.AddMinutes(Int32.Parse(lineMatchVideoLength.Groups["VideoMin"].ToString().Trim()));
                videoLength =
                    videoLength.AddSeconds(Int32.Parse(lineMatchVideoLength.Groups["VideoSec"].ToString().Trim()));
                videoLength =
                    videoLength.AddMilliseconds(
                        Int32.Parse(lineMatchVideoLength.Groups["VideoHsec"].ToString().Trim()) * 10);
            }
            catch (Exception e1)
            {
