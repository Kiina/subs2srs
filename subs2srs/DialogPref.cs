...
namespace subs2srs
{
    public partial class DialogPref : Form
    {
        ...
        public DialogPref()
        {
            ...
            propTable["Remove Subs1 Lines With No Obvious Counterpart"] =
                ConstantSettings.DefaultRemoveNoCounterpartSubs1;
            ...
            propTable["Remove Subs2 Lines With No Obvious Counterpart"] =
                ConstantSettings.DefaultRemoveNoCounterpartSubs2;
            ...
            propTable.Properties.Add(new PropertySpec("Exclude Lines With Fewer Than n Characters Enable Subs1",
                typeof(bool),
                "User Interface Defaults",
            ...
            propTable["Exclude Lines With Fewer Than n Characters Enable Subs1"] =
                ConstantSettings.DefaultExcludeLinesFewerThanCharsSubs1;

            // default_exclude_lines_with_fewer_than_n_chars_subs2
            propTable.Properties.Add(new PropertySpec("Exclude Lines With Fewer Than n Characters Enable Subs2",
                typeof(bool),
                "User Interface Defaults",
            ...
            propTable["Exclude Lines With Fewer Than n Characters Enable Subs2"] =
                ConstantSettings.DefaultExcludeLinesFewerThanCharsSubs2;

            // default_exclude_lines_with_fewer_than_n_chars_num_subs1
            propTable.Properties.Add(new PropertySpec("Exclude Lines With Fewer Than n Characters Number Subs1",
                typeof(int),
                "User Interface Defaults",
            ...
            propTable["Exclude Lines With Fewer Than n Characters Number Subs1"] =
                ConstantSettings.DefaultExcludeLinesFewerThanCharsNumSubs1;

            // default_exclude_lines_with_fewer_than_n_chars_num_subs2
            propTable.Properties.Add(new PropertySpec("Exclude Lines With Fewer Than n Characters Number Subs2",
                typeof(int),
                "User Interface Defaults",
            ...
            propTable["Exclude Lines With Fewer Than n Characters Number Subs2"] =
                ConstantSettings.DefaultExcludeLinesFewerThanCharsNumSubs2;

            // default_exclude_lines_shorter_than_n_ms_subs1
            propTable.Properties.Add(new PropertySpec("Exclude Lines Shorter Than n Milliseconds Enable Subs1",
                typeof(bool),
                "User Interface Defaults",
            ...
            propTable["Exclude Lines Shorter Than n Milliseconds Enable Subs1"] =
                ConstantSettings.DefaultExcludeLinesShorterThanMsSubs1;

            // default_exclude_lines_shorter_than_n_ms_subs2
            propTable.Properties.Add(new PropertySpec("Exclude Lines Shorter Than n Milliseconds Enable Subs2",
                typeof(bool),
                "User Interface Defaults",
            ...
            propTable["Exclude Lines Shorter Than n Milliseconds Enable Subs2"] =
                ConstantSettings.DefaultExcludeLinesShorterThanMsSubs2;

            // default_exclude_lines_shorter_than_n_ms_num_subs1
            propTable.Properties.Add(new PropertySpec("Exclude Lines Shorter Than n Milliseconds Number Subs1",
                typeof(int),
                "User Interface Defaults",
            ...
            propTable["Exclude Lines Shorter Than n Milliseconds Number Subs1"] =
                ConstantSettings.DefaultExcludeLinesShorterThanMsNumSubs1;

            // default_exclude_lines_shorter_than_n_ms_num_subs2
            propTable.Properties.Add(new PropertySpec("Exclude Lines Shorter Than n Milliseconds Number Subs2",
                typeof(int),
                "User Interface Defaults",
            ...
            propTable["Exclude Lines Shorter Than n Milliseconds Number Subs2"] =
                ConstantSettings.DefaultExcludeLinesShorterThanMsNumSubs2;

            // default_exclude_lines_longer_than_n_ms_subs1
            propTable.Properties.Add(new PropertySpec("Exclude Lines Longer Than n Milliseconds Enable Subs1",
                typeof(bool),
                "User Interface Defaults",
            ...
            propTable["Exclude Lines Longer Than n Milliseconds Enable Subs1"] =
                ConstantSettings.DefaultExcludeLinesLongerThanMsSubs1;

            // default_exclude_lines_longer_than_n_ms_subs2
            propTable.Properties.Add(new PropertySpec("Exclude Lines Longer Than n Milliseconds Enable Subs2",
                typeof(bool),
                "User Interface Defaults",
            ...
            propTable["Exclude Lines Longer Than n Milliseconds Enable Subs2"] =
                ConstantSettings.DefaultExcludeLinesLongerThanMsSubs2;

            // default_exclude_lines_longer_than_n_ms_num_subs1
            propTable.Properties.Add(new PropertySpec("Exclude Lines Longer Than n Milliseconds Number Subs1",
                typeof(int),
                "User Interface Defaults",
            ...
            propTable["Exclude Lines Longer Than n Milliseconds Number Subs1"] =
                ConstantSettings.DefaultExcludeLinesLongerThanMsNumSubs1;

            // default_exclude_lines_longer_than_n_ms_num_subs2
            propTable.Properties.Add(new PropertySpec("Exclude Lines Longer Than n Milliseconds Number Subs2",
                typeof(int),
                "User Interface Defaults",
            ...
            propTable["Exclude Lines Longer Than n Milliseconds Number Subs2"] =
                ConstantSettings.DefaultExcludeLinesLongerThanMsNumSubs2;

            // default_join_sentences_subs1
            propTable.Properties.Add(new PropertySpec(
                "Join Lines That End With One of the Following Characters Enable Subs1", typeof(bool),
                "User Interface Defaults",
            ...
            propTable["Join Lines That End With One of the Following Characters Enable Subs1"] =
                ConstantSettings.DefaultJoinSentencesSubs1;

            // default_join_sentences_subs2
            propTable.Properties.Add(new PropertySpec(
                "Join Lines That End With One of the Following Characters Enable Subs2", typeof(bool),
                "User Interface Defaults",
            ...
            propTable["Join Lines That End With One of the Following Characters Enable Subs2"] =
                ConstantSettings.DefaultJoinSentencesSubs2;

            // default_join_sentences_char_list_subs1
            propTable.Properties.Add(new PropertySpec("Join Lines That End With One of the Following Characters Subs1",
                typeof(string),
                "User Interface Defaults",
            ...
            propTable["Join Lines That End With One of the Following Characters Subs1"] =
                convertToTokens(ConstantSettings.DefaultJoinSentencesCharListSubs1);

            // default_join_sentences_char_list_subs2
            propTable.Properties.Add(new PropertySpec("Join Lines That End With One of the Following Characters Subs2",
                typeof(string),
                "User Interface Defaults",
            ...
            propTable["Join Lines That End With One of the Following Characters Subs2"] =
                convertToTokens(ConstantSettings.DefaultJoinSentencesCharListSubs2);
            ...
            propTable["Extract Audio From Media Filename Format"] =
                convertToTokens(ConstantSettings.ExtractMediaAudioFilenameFormat);
            ...
            propTable["Dueling Subtitles Filename Format"] =
                convertToTokens(ConstantSettings.DuelingSubtitleFilenameFormat);
            ...
            propTable["Quick Reference Filename Format"] =
                convertToTokens(ConstantSettings.DuelingQuickRefFilenameFormat);
        ...
        {
            resizeDescriptionArea(ref propertyGridPref, 6);
        }
        ...
        private void resizeDescriptionArea(ref PropertyGrid grid, int numLines)
        {
            try
            {
                ...
                System.Windows.Forms.Control.ControlCollection cc =
                    (System.Windows.Forms.Control.ControlCollection) pi.GetValue(grid, null);
        ...
        private void buttonOK_Click(object sender, EventArgs e)
        {
            ...
            pairList.Add(new PrefIO.SettingsPair("main_window_height",
                UtilsCommon.checkRange((int) propTable["Main Window Height"], 0, 9999, PrefDefaults.MainWindowHeight)
                    .ToString()));
            pairList.Add(new PrefIO.SettingsPair("default_enable_audio_clip_generation",
                propTable["Enable Audio Clip Generation"].ToString()));
            pairList.Add(new PrefIO.SettingsPair("default_enable_snapshots_generation",
                propTable["Enable Snapshots Generation"].ToString()));
            pairList.Add(new PrefIO.SettingsPair("default_enable_video_clips_generation",
                propTable["Enable Video Clips Generation"].ToString()));
            pairList.Add(new PrefIO.SettingsPair("default_audio_clip_bitrate",
                UtilsCommon.checkRangeInSet<int>((int) propTable["Audio Clip Bitrate"],
                    new List<int>(new int[] {32, 40, 48, 56, 64, 80, 96, 112, 128, 144, 160, 192, 224, 256, 320}),
            ...
            pairList.Add(new PrefIO.SettingsPair("default_video_clip_video_bitrate",
                UtilsCommon.checkRange((int) propTable["Video Clip Video Bitrate"], 100, 3000,
                    PrefDefaults.DefaultVideoClipVideoBitrate).ToString()));
            ...
            pairList.Add(new PrefIO.SettingsPair("default_context_num_leading",
                UtilsCommon.checkRange((int) propTable["Context Number Leading"], 0, 9,
                    PrefDefaults.DefaultContextNumLeading).ToString()));
            pairList.Add(new PrefIO.SettingsPair("default_context_num_trailing",
                UtilsCommon.checkRange((int) propTable["Context Number Trailing"], 0, 9,
                    PrefDefaults.DefaultContextNumTrailing).ToString()));
            pairList.Add(new PrefIO.SettingsPair("default_context_leading_range",
                UtilsCommon.checkRange((int) propTable["Context Nearby Line Range Leading"], 0, 99999,
                    PrefDefaults.DefaultContextLeadingRange).ToString()));
            pairList.Add(new PrefIO.SettingsPair("default_context_trailing_range",
                UtilsCommon.checkRange((int) propTable["Context Nearby Line Range Trailing"], 0, 99999,
                    PrefDefaults.DefaultContextTrailingRange).ToString()));
            pairList.Add(new PrefIO.SettingsPair("default_file_browser_start_dir",
                convertOut("File Browser Start Folder")));
            pairList.Add(new PrefIO.SettingsPair("default_remove_styled_lines_subs1",
                propTable["Remove Subs1 Styled Lines"].ToString()));
            pairList.Add(new PrefIO.SettingsPair("default_remove_styled_lines_subs2",
                propTable["Remove Subs2 Styled Lines"].ToString()));
            pairList.Add(new PrefIO.SettingsPair("default_remove_no_counterpart_subs1",
                propTable["Remove Subs1 Lines With No Obvious Counterpart"].ToString()));
            pairList.Add(new PrefIO.SettingsPair("default_remove_no_counterpart_subs2",
                propTable["Remove Subs2 Lines With No Obvious Counterpart"].ToString()));
            ...
            pairList.Add(new PrefIO.SettingsPair("default_exclude_duplicate_lines_subs1",
                propTable["Exclude Duplicate Lines Subs1"].ToString()));
            pairList.Add(new PrefIO.SettingsPair("default_exclude_duplicate_lines_subs2",
                propTable["Exclude Duplicate Lines Subs2"].ToString()));
            pairList.Add(new PrefIO.SettingsPair("default_exclude_lines_with_fewer_than_n_chars_subs1",
                propTable["Exclude Lines With Fewer Than n Characters Enable Subs1"].ToString()));
            pairList.Add(new PrefIO.SettingsPair("default_exclude_lines_with_fewer_than_n_chars_subs2",
                propTable["Exclude Lines With Fewer Than n Characters Enable Subs2"].ToString()));
            pairList.Add(new PrefIO.SettingsPair("default_exclude_lines_with_fewer_than_n_chars_num_subs1",
                UtilsCommon.checkRange((int) propTable["Exclude Lines With Fewer Than n Characters Number Subs1"], 2,
                    99999, PrefDefaults.DefaultExcludeLinesFewerThanCharsNumSubs1).ToString()));
            pairList.Add(new PrefIO.SettingsPair("default_exclude_lines_with_fewer_than_n_chars_num_subs2",
                UtilsCommon.checkRange((int) propTable["Exclude Lines With Fewer Than n Characters Number Subs2"], 2,
                    99999, PrefDefaults.DefaultExcludeLinesFewerThanCharsNumSubs2).ToString()));
            pairList.Add(new PrefIO.SettingsPair("default_exclude_lines_shorter_than_n_ms_subs1",
                propTable["Exclude Lines Shorter Than n Milliseconds Enable Subs1"].ToString()));
            pairList.Add(new PrefIO.SettingsPair("default_exclude_lines_shorter_than_n_ms_subs2",
                propTable["Exclude Lines Shorter Than n Milliseconds Enable Subs2"].ToString()));
            pairList.Add(new PrefIO.SettingsPair("default_exclude_lines_shorter_than_n_ms_num_subs1",
                UtilsCommon.checkRange((int) propTable["Exclude Lines Shorter Than n Milliseconds Number Subs1"], 100,
                    99999, PrefDefaults.DefaultExcludeLinesShorterThanMsNumSubs1).ToString()));
            pairList.Add(new PrefIO.SettingsPair("default_exclude_lines_shorter_than_n_ms_num_subs2",
                UtilsCommon.checkRange((int) propTable["Exclude Lines Shorter Than n Milliseconds Number Subs2"], 100,
                    99999, PrefDefaults.DefaultExcludeLinesShorterThanMsNumSubs2).ToString()));
            pairList.Add(new PrefIO.SettingsPair("default_exclude_lines_longer_than_n_ms_subs1",
                propTable["Exclude Lines Longer Than n Milliseconds Enable Subs1"].ToString()));
            pairList.Add(new PrefIO.SettingsPair("default_exclude_lines_longer_than_n_ms_subs2",
                propTable["Exclude Lines Longer Than n Milliseconds Enable Subs2"].ToString()));
            pairList.Add(new PrefIO.SettingsPair("default_exclude_lines_longer_than_n_ms_num_subs1",
                UtilsCommon.checkRange((int) propTable["Exclude Lines Longer Than n Milliseconds Number Subs1"], 100,
                    99999, PrefDefaults.DefaultExcludeLinesLongerThanMsNumSubs1).ToString()));
            pairList.Add(new PrefIO.SettingsPair("default_exclude_lines_longer_than_n_ms_num_subs2",
                UtilsCommon.checkRange((int) propTable["Exclude Lines Longer Than n Milliseconds Number Subs2"], 100,
                    99999, PrefDefaults.DefaultExcludeLinesLongerThanMsNumSubs2).ToString()));
            pairList.Add(new PrefIO.SettingsPair("srs_filename_format", preventBlank("SRS Filename Format")));
            pairList.Add(new PrefIO.SettingsPair("default_join_sentences_subs1",
                propTable["Join Lines That End With One of the Following Characters Enable Subs1"].ToString()));
            pairList.Add(new PrefIO.SettingsPair("default_join_sentences_subs2",
                propTable["Join Lines That End With One of the Following Characters Enable Subs2"].ToString()));
            pairList.Add(new PrefIO.SettingsPair("default_join_sentences_char_list_subs1",
                preventBlank("Join Lines That End With One of the Following Characters Subs1")));
            pairList.Add(new PrefIO.SettingsPair("default_join_sentences_char_list_subs2",
                preventBlank("Join Lines That End With One of the Following Characters Subs2")));
            ...
            pairList.Add(new PrefIO.SettingsPair("extract_media_audio_filename_format",
                preventBlank("Extract Audio From Media Filename Format")));
            pairList.Add(new PrefIO.SettingsPair("extract_media_lyrics_subs1_format",
                preventBlank("Lyrics Subs1 Format")));
            pairList.Add(
                new PrefIO.SettingsPair("extract_media_lyrics_subs2_format", convertOut("Lyrics Subs2 Format")));
            pairList.Add(new PrefIO.SettingsPair("dueling_subtitle_filename_format",
                preventBlank("Dueling Subtitles Filename Format")));
            pairList.Add(new PrefIO.SettingsPair("dueling_quick_ref_filename_format",
                preventBlank("Quick Reference Filename Format")));
            pairList.Add(new PrefIO.SettingsPair("dueling_quick_ref_subs1_format",
                preventBlank("Quick Reference Subs1 Format")));
            pairList.Add(new PrefIO.SettingsPair("dueling_quick_ref_subs2_format",
                convertOut("Quick Reference Subs2 Format")));
            ...
            pairList.Add(new PrefIO.SettingsPair("reencode_before_splitting_audio",
                propTable["Re-encode Before Splitting Audio"].ToString()));
            ...
            pairList.Add(new PrefIO.SettingsPair("long_clip_warning_seconds",
                UtilsCommon.checkRange((int) propTable["Long Clip Warning"], 0, 99999,
                    PrefDefaults.LongClipWarningSeconds).ToString()));
        ...
        {
            bool confirmed =
                UtilsMsg.showConfirm("Are you sure that you want to reset all preferences to default values?");
        ...
        {
            GridItem item = propertyGridPref.SelectedGridItem;
